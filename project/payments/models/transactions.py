...
class Transaction(TimeStampParentModel):
    ...
    sender = models.ForeignKey('payments.Wallet', on_delete=models.CASCADE, related_name='requested_transactions',
                               null=True)
    receiver = models.ForeignKey('payments.Wallet', on_delete=models.CASCADE, related_name='received_transactions')
