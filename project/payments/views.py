...
from .use_cases import GetWalletInteractor, CreateTransactionInteractor, UpdateTransactionInteractor, \
    CreateInvoiceInteractor, UpdateWalletBalanceInteractor, MakeTransferInteractor
...
from .serializers import WalletSerializer, TransactionSerializer, TransactionCreateSerializer, InvoicePaySerializer
...
class BalanceView(APIView):
    ...
    def get(self, request):
        wallet = (GetWalletInteractor()
                  .set_params(request.user)
                  .execute())
        serializer = WalletSerializer(wallet)
        return Response(serializer.data)


class TransactionsViewSet(mixins.RetrieveModelMixin,
    ...
    def make_deposits(self, request):
        ...
        wallet = (UpdateWalletBalanceInteractor()
